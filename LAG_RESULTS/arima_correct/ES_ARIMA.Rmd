...
#############################################
source("commented_clean_ARIMA.R", local = TRUE, chdir = TRUE)
...
one_state<-list(list_of_states[['Colorado']][100:250,])

example_single_state <- mclapply(one_state, ES_ARIMA, ES27=TRUE, n_weeks_ahead=2, mc.cores=4)
